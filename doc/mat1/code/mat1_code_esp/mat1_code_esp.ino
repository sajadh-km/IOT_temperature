...
int return_payload()
{
 ...
 char  num[10];
  memset(payload, 0x00, 370);
  sprintf(payload, "%d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d, %d \n",
    raw_data.fsr1,raw_data.fsr2,  raw_data.fsr3,  raw_data.fsr4,  raw_data.fsr5,  
    raw_data.fsr6,  raw_data.fsr7,  raw_data.fsr8,  raw_data.fsr9,  raw_data.fsr10, 
    raw_data.fsr11,  raw_data.fsr12,  raw_data.fsr13,  raw_data.fsr14,raw_data.fsr15,
    raw_data.fsr16);
  return 0;
}
